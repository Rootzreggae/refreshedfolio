        ...
        case 'side-by-side': {
          ...
          node.attributes = [
            ...
            ...(image
              ...
              : []),
            ...(imageAlt
              ? [{ type: 'mdxJsxAttribute', name: 'imageAlt', value: imageAlt }]
              : []),
            ...(imageCaption
              ? [
                  {
          ...
          node.attributes = [
            {
              type: 'mdxJsxAttribute',
              name: 'title',
              value: title || 'Expandable Section',
            },
            ...(defaultOpen === 'true'
              ? [
                  {
        ...
        case 'image-grid': {
          ...
          node.attributes = [
            ...
            ...(columns
              ...
              : []),
            ...(gap
              ? [{ type: 'mdxJsxAttribute', name: 'gap', value: gap }]
              : []),
          ];
          node.children = [];
          break;
